...
- Added a post-`v0.1.6` polish pass for the Solar Energy author-review draft: Figure 1 keeps the author-owned DJI aerial photograph unedited, the China locator/geometry panel is cleaner, the TikZ workflow is more journal-like, and the final clean release-clone PDF identifies as 40 pages, 30,905,489 bytes, SHA-256 `9b5b2cdbd283a08d525d1439bb60d75b7e431a78cfedbe0c5201668c920861e5`. If this PDF is submitted, publish it as `v0.1.7` before minting the Zenodo DOI.
...
- Treat GitHub `v0.1.6` as the previous verified public release, and treat the current Figure 1/Figure 2 polish package as the `v0.1.7` release target. Mint the Zenodo DOI from the exact release that matches the submitted PDF.
