...
| DOI/Zenodo remains required | Accepted as blocking item | Manuscript now lists the GitHub v0.1.2 release and explicitly states that a Zenodo DOI should be minted before final journal submission if required. No fake DOI was inserted. |
